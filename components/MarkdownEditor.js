...
class MarkdownEditor extends Component{
	...
	onChange = (e) => {
		...
		if (typeof this.props.onChange === "function") {
			this.props.onChange(this.props.name, React.findDOMNode(this.refs["editor"]).value);
		}
		if (typeof this.props.onValueChange === "function") {
			this.props.onValueChange(React.findDOMNode(this.refs["editor"]).value, this.props.name);
		}
		return false;
	}
	onSubmit = (e) => {
